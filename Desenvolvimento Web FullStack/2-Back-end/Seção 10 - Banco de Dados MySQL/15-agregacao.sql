#Funções de agregação - Os operadores retornam respectivamente o menor, maior ou a média dos valores de todos os registros com base em uma coluna
...
#O primeiro operador retrona a soma dos valores de todos os registros com base em uma coluna. O segundo operador retorna a quantidade de todos os registros de uma tabela
